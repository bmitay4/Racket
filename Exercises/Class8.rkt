...
Last lesson, we discussed on defining a fun function with its body, and use the call function to implement it on the given value,
...
To do this, we will make a number of changes to our syntax tree (AST) and our Grammer
